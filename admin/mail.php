...
class MySendMail
{
     ...
     * @return boolean
     */
    public function setServer($server, $username = "", $password = "", $port = 465)
    {
...
/**************************** Test ***********************************/
$mail = new MySendMail();
$mail->setServer("smtp.qq.com", "616315821@qq.com", "mtiujdgaxhjhbeja");
$mail->setFrom("616315821@qq.com");
$mail->setReceiver("616315821@qq.com");
